...
# Thiết lập logging
logging.basicConfig(level=logging.INFO, filename='result_tafeng.log', filemode='w',
...
def tune_parameters(transactions_file, weights_file):
    ...
    results_df.to_csv('result_tafeng.csv', index=False)
    logging.info("Results saved to result_tafeng.csv")
    print("\nResults saved to result_tafeng.csv")
