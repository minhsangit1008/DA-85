...
def get_memory_usage():
    ...
    logging.debug(f"Memory measured: {mem:.10f} MB")
    return mem
...
def tune_parameters(transactions_file, weights_file):
    ...
    min_ws_values = [0.0001, 0.0003, 0.0005]
    min_wio_values = [0.0003, 0.0005, 0.001]
    ...
    for min_wio in min_wio_values:
        for min_ws in min_ws_values:
            ...
            logging.info(f"Results: {num_itemsets} itemsets, {time_taken:.7f}s, {memory_used:.7f}MB")
