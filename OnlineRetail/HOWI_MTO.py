...
def get_memory_usage():
    ...
    logging.debug(f"Memory measured: {mem:.7f} MB")
    return mem
...
def tune_parameters(transactions_file, weights_file):
    ...
    for min_wio in min_wio_values:
        for min_ws in min_ws_values:
            ...
            logging.info(f"Results: {num_itemsets} itemsets, {time_taken:.5f}s, {memory_used:.5f}MB")
    ...
    logging.info("Results saved to result.csv")
